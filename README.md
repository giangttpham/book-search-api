...
## AWS EC2 instance
This app is currently running as a Micro EC2 instance on AWS using `nginx`. Visit https://3.137.151.190/docs for the Book Search API docs (generated by Swagger).
